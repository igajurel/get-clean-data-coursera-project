...
This code book describes the data, the variables, and any transformations or work that you performed to clean up the data.
...
## Details on transformation of data

The transformation process for this project involves following 5 steps:
